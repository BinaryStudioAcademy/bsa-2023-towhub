...
class MapService {
  ...
  private initMap(mapElement: HTMLDivElement, center: google.maps.LatLngLiteral, zoom: number): void {
  ...
  public async calculateRouteAndTime(origin: google.maps.LatLngLiteral, destination: google.maps.LatLngLiteral): Promise<number> {
  ...
  public async calculateDistance(origin: google.maps.LatLngLiteral, destination: google.maps.LatLngLiteral): Promise<number> {
      this.throwIfMapNotInitialized();
