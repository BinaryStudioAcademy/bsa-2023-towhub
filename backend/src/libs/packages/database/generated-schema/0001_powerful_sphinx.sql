...
INSERT INTO "groups" (name, key) VALUES ('Customer', 'customer'), ('Buisness','business'), ('Driver', 'driver'); 
...
ALTER TABLE "users" ADD COLUMN "group_id" integer NOT NULL;--> statement-breakpoint
DO $$ BEGIN
