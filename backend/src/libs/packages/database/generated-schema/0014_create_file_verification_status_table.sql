...
--> statement-breakpoint
ALTER TABLE "trucks"
DROP CONSTRAINT "trucks_business_id_business_details_id_fk";

--> statement-breakpoint
ALTER TABLE "users_trucks"
DROP CONSTRAINT "users_trucks_id";

--> statement-breakpoint
ALTER TABLE "users_trucks"
DROP CONSTRAINT "unique_user_id_truck_id";
...
--> statement-breakpoint
ALTER TABLE "users_trucks"
ADD CONSTRAINT "users_trucks_user_id_truck_id" PRIMARY KEY ("user_id", "truck_id");
